  ...
  const handleFileUpload = async (e, docType) => {
    ...
    if (file) {
      ...
      try {
        ...
        // Create a loading toast and keep the ID
        uploadToastId = toast.loading(`Uploading ${file.name}...`);
        ...
        // Error: Update the EXISTING toast so the loading spinner goes away
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[12, 24, 36, 48].map((months) => {
                      ...
                      return (
                        <div
                          key={months}
                          className={`p-4 rounded-xl border-2 transition-all cursor-pointer ${months === loanTenure
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div className="sm:col-span-2">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors text-lg ${errors.fullName
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors ${errors.email
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors ${errors.phone
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      />
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        min="500000"
                        max="50000000"
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors ${errors.loanAmount
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      />
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        required
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors ${errors.purpose
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        required
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors ${errors.employment
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        placeholder="₹ 25,000"
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors ${errors.monthlyIncome
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors ${errors.companyName
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        placeholder="5"
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors ${errors.workExperience
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      />
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        maxLength="10"
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors uppercase ${errors.panNumber
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        maxLength="12"
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors ${errors.aadharNumber
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      />
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <textarea
                        ...
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors resize-none ${errors.address
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors ${errors.city
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors ${errors.state
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="400001"
                        maxLength="6"
                        className={`w-full px-4 py-3.5 border-2 rounded-xl focus:outline-none transition-colors ${errors.pincode
                          ? 'border-red-500 focus:border-red-600 bg-red-50'
                          : 'border-gray-200 focus:border-green-500'
                          }`}
                      />
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    ...
                    {[
                      ...
                      <div key={doc.key} className={doc.key === 'photo' ? 'sm:col-span-2' : ''}>
                        <div className={`relative border-2 border-dashed rounded-2xl p-6 transition-all duration-300 ${documents[doc.key]
              ...
              {currentStep < 5 && (
                <div className="flex items-center justify-between mt-10 pt-8 border-t-2 border-gray-200">
                  <button
                    ...
                    className={`inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold transition-all duration-300 ${currentStep === 1 || isTransitioning
                  ...
                  {currentStep < 4 ? (
                    <button
                      ...
                      className={`inline-flex items-center gap-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-bold px-8 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 ${isTransitioning ? 'opacity-75 cursor-not-allowed' : ''
                        }`}
                    >
                      {isTransitioning ? (
                        <>
