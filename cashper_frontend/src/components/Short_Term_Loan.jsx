...
const Short_Term_Loan = ({ isPopupMode = false, onPopupClose }) => {
  ...
  const handleFileUpload = async (e, docType) => {
    ...
    if (file) {
      ...
      try {
        ...
        const uploadUrl = `${API_BASE_URL}/api/short-term-loan/upload-document`;
  ...
  const successStories = [
    ...
    },
    {
      ...
      image: "/testimonial/testimonial-4.png"
    },
    {
      name: "Vinita Singh",
      location: "Pune",
      ...
      image: "/testimonial/testimonial-5.png"
    }
  ];
                ...
                <div className="flex items-center justify-between mt-10 pt-8 border-t-2 border-gray-200">
                  ...
                  {currentStep < 4 ? (
                    ...
                    <button
                      ...
                      className={`inline-flex items-center gap-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-bold px-8 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 ${(isTransitioning || isSubmitting) ? 'opacity-75 cursor-not-allowed' : ''
                        }`}
                    >
