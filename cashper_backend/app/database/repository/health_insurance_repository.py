...
class HealthInsuranceRepository:
    ...
    def get_inquiry_collection(self):
        ...
        return self.db["health_insurance_inquiries"]
    
    def get_application_collection(self):
        """Lazy initialization for application collection"""
        if self.db is None:
            self.db = get_database()
        return self.db["health_insurance_applications"]

    # ==================== INQUIRY OPERATIONS ====================
    
    def create_inquiry(self, inquiry_data: HealthInsuranceInquiryInDB) -> str:
        """Create a new health insurance inquiry"""
    ...
    def create_application(self, application_data: HealthInsuranceApplicationInDB) -> str:
        """Create a new health insurance application"""
...
health_insurance_repository = HealthInsuranceRepository()
